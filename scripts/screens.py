from anim_demo import WINDOW_HEIGHT, WINDOW_WIDTH
...
class HomeScreen(ScreenBase):
    def __init__(self):
        ...
        self.play_label = ClickableLabel(os.path.join(configs.PATH_LABELS, "play_game_label.png"), os.path.join(configs.PATH_LABELS, "clickable_play_game_label.png"),
                                        (configs.WINDOW_WIDTH/2, configs.WINDOW_HEIGHT/3), 0.15)
        ...
        self.rules_label = ClickableLabel(os.path.join(configs.PATH_LABELS, "rules_label.png"), os.path.join(configs.PATH_LABELS,"clickable_rules_label.png"), (configs.WINDOW_WIDTH/2, configs.WINDOW_HEIGHT/2.25 ), 0.15)
        self.rules_label.add_click_listener(lambda : change_screen(RuleScreen()))
        self.exit_label = ExitGameLabel(os.path.join(configs.PATH_LABELS, "exit_label.png"), os.path.join(configs.PATH_LABELS, "clickable_exit_label.png"), (configs.WINDOW_WIDTH/2, configs.WINDOW_HEIGHT/1.8), 0.15)
...
class RuleScreen(ScreenBase):
    def __init__(self):
        ...
        self.back_label = BackLabel(os.path.join(configs.PATH_LABELS, "back_label.png"), os.path.join(configs.PATH_LABELS, "clickable_back_label.png"), (configs.WINDOW_WIDTH/1.2, configs.WINDOW_HEIGHT/1.1), 0.1)
...
class StartGameScreen(ScreenBase):
    def __init__(self):
        ...
        self.back_label = BackLabel(os.path.join(configs.PATH_LABELS, "back_label.png"),
                                    os.path.join(configs.PATH_LABELS, "clickable_back_label.png"),
                                    (configs.WINDOW_WIDTH / 1.2, configs.WINDOW_HEIGHT / 1.1), 0.1)
        self.objects.append(self.back_label)
...
class PlayScreen(ScreenBase):
    def __init__(self, num_players):
        ...
        self.deck_label = ClickableLabel( os.path.join(configs.PATH_LABELS, "deck_label.png"), os.path.join(configs.PATH_LABELS,"clickable_deck_label.png"), (configs.WINDOW_WIDTH/2,configs.WINDOW_HEIGHT/2.18), 0.175)
        self.game_pass_label = ClickableLabel(os.path.join(configs.PATH_LABELS, "game_pass_label.png"), os.path.join(configs.PATH_LABELS,"clickable_game_pass_label.png"),
                                             (configs.WINDOW_WIDTH/1.5, configs.WINDOW_HEIGHT/1.075),0.09)  # Position the label horizontally at the bottom
        self.quit_game_label = QuitGameLabel(os.path.join(configs.PATH_LABELS, "quit_game_label.png"),
                                              os.path.join(configs.PATH_LABELS, "clickable_quit_game_label.png"),
                                              (configs.WINDOW_WIDTH/1.1, configs.WINDOW_HEIGHT/1.1),0.1)  # Position the label horizontally at the bottom

        self.draw_from_deck_label = ClickableLabel(os.path.join(configs.PATH_LABELS,"draw_from_deck_label.png"), os.path.join(configs.PATH_LABELS,"clickable_draw_from_deck_label.png"),
                                             (configs.WINDOW_WIDTH/3.9, configs.WINDOW_HEIGHT/1.6),0.19)
        self.draw_from_player_label = ClickableLabel(os.path.join(configs.PATH_LABELS, "draw_from_player_label.png"), os.path.join(configs.PATH_LABELS, "clickable_draw_from_player_label.png"),
                                                     (configs.WINDOW_WIDTH/1.5, configs.WINDOW_HEIGHT/1.6), 0.19)
        self.discard_label = ClickableLabel(os.path.join(configs.PATH_LABELS,"discard_label.png"), os.path.join(configs.PATH_LABELS,"clickable_discard_label.png"), (configs.WINDOW_WIDTH/2, configs.WINDOW_HEIGHT/1.075),0.09)
        self.play_for_me_label = ClickableLabel(os.path.join(configs.PATH_LABELS,"play_for_me_label.png"),
                                                os.path.join(configs.PATH_LABELS,"clickable_play_for_me_label.png"), (configs.WINDOW_WIDTH/4, configs.WINDOW_HEIGHT/1.075),0.09)

        # Add the clickable labels to the objects list
        self.objects.append(self.deck_label)
        self.objects.append(self.game_pass_label)
        self.objects.append(self.draw_from_deck_label)
        self.objects.append(self.draw_from_player_label)
...
class CongratsScreen(ScreenBase):
    def __init__(self):
        ...
        self.newgame_label = NewGameLabel("labels/new_game_label.png", "labels/clickable_new_game_label.png",
                                          (350, 250))
        self.quitgame_label = ExitGameLabel("labels/quit_game_label.png", "labels/clickable_quit_game_label.png", (350, 350))

        # Create the clickable labels with their image files and positions
        self.objects.append(self.newgame_label)
        self.objects.append(self.quitgame_label)
...
class LoseScreen(ScreenBase):
    def __init__(self):
        ...
        self.newgame_label = NewGameLabel("labels/new_game_label.png", "labels/clickable_new_game_label.png",
                                          (350, 250))
        self.quitgame_label = ExitGameLabel("labels/quit_game_label.png", "labels/clickable_quit_game_label.png",
                                            (350, 350))
